...
const ThankYouCard = () => (
  <div className="card">
    <div className="relative m-auto bg-black w-[300px] sm:w-[350px] group transition-all duration-700 aspect-video flex items-center justify-center">
      <div className="transition-all flex flex-col items-center py-5 justify-start duration-300 group-hover:duration-1000 bg-white w-full h-full absolute group-hover:-translate-y-16">
        ...
        <p className="font-sans text-[10px] text-gray-700 pt-5"> Thank You</p>
      </div>
